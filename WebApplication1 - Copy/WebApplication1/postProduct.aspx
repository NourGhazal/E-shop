<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="postProduct.aspx.cs" Inherits="WebApplication1.postProduct" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Button ID="Button1" runat="server" Text="Post" OnClick="postProducts" />
        </div>
    </form>
</body>
</html>
